...
<body>
	...
	<?php require_once"../../menu2.php";?>
		...
		<?php
			...
			#querys
			$insert = "INSERT INTO usuario_gestor (usuario, nome, senha, nivel, email, rastro_usuario) VALUES ('$usuario_cadastrar','$nome', MD5('$senha'), '$nivel', '$email', '$rastro')";
			...
			if ($validacao = mysqli_num_rows($testa_dados)){
				...
				if($nome==""){
					...
					insert($insert);
					echo "<div class='cadastro_realizado'><h1>Cadastro realizado. <i class='fa fa-smile-o' aria-hidden='true'></i></h1></div>";
				}
			}
