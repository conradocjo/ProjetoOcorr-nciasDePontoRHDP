			...
			$unidades = isset($_POST['unidades'])?$_POST['unidades']:$unidade_aprovada;
 			...
 			while ($resultado2 = mysqli_fetch_array($select_gestor)) {
					...
					if (mysqli_num_rows($select_ocorrencia)) {
 						echo"<form class='aprova'  action='aprovadas_unidades_sucess.php' method='post' accept-charset='utf-8'>
							...
							<input type='hidden' name='unity' value='$unidades'>
 						...
 						echo "<div class='cadastro_existente'><h1>Você não tem ocorrências para serem aprovadas. $unidades</h1></div>";
 					}
