...
<body>
	...
	<div class="container container_relatorios">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="divisao_relatorio btn-relatorio2">
					<a class="btn btn-relatorio2" href="total_justificativa.php"><i class="fa fa-pie-chart" aria-hidden="true"></i> Aprovadas e não aprovadas</a>
				</div>
			</div>
			<div class="col-md-3">
				<div class="divisao_relatorio">
					<button id='btn_ocorrencias_total_unidades' class="btn btn-relatorio"><i class="fa fa-bar-chart" aria-hidden="true"></i> Total por unidades</button>
				</div>
			</div>
			<div class="col-md-3">
				<div class="divisao_relatorio">
		...
		<div class="row">
			<div class="col-md-3 ">
				<div class="divisao_relatorio">
					<button class='btn btn-relatorio' id="btn_relatorio_unidade"><i class="fa fa-list-ol" aria-hidden="true"></i> Relatório por unidade</button>
				</div>
			</div>
			<div class="col-md-3">
				<div class="divisao_relatorio">
			...
			<div class="modal fade" id="ocorrencias_total_unidades" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			  <div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			       		<form class="formulario_relat" action="total_ocorrencia_unidade.php" method="post" accept-charset="utf-8">
			        		...
			        		<?php
								...
								while ($resultado9 = mysqli_fetch_array($select_unidade)) {
