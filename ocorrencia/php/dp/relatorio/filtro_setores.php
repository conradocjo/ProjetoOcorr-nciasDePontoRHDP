...
<body>
	...
	<div class="container" style='overflow: auto; height: 420px'>
		...
		<?php
			...
			#dados da sessão
			$setor_aprovado = isset($_SESSION['aprova'])?$_SESSION['aprova']:'';
			$usuario = isset($_SESSION['usuario'])?$_SESSION['usuario']:'';
			$setores = isset($_POST['setores'])?$_POST['setores']:$setor_aprovado;
 			...
 			while ($resultado2 = mysqli_fetch_array($select_gestor)) {
					...
					if (mysqli_num_rows($select_ocorrencia)) {
 						echo"<form class='aprova'  action='aprovadas_setores_sucess.php' method='post' accept-charset='utf-8'>
							...
							<input type='hidden' name='sector' value='$setores'>
