...
<body>
	...
	<?php require_once"../../menu.php";?>
		...
		<?php
			...
			#querys
			$sql_select = "SELECT * FROM unidade WHERE nome = '$nome_unidade' OR endereco = '$endereco_unidade' ORDER BY nome";
			$insert = "UPDATE unidade SET nome = '$nome_unidade' , endereco = '$endereco_unidade' , usuario_rastro_atualizacao = '$rastro' WHERE id = '$unidade'  ";
