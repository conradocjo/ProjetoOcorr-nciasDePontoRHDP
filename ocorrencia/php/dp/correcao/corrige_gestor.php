...
<body>
	...
	<div class="">
		<form class="form_cadastro_unidade" action="corrigindo_gestor.php" method="post" accept-charset="utf-8">
		<fieldset>
			<legend>Correção de cadastros</legend>
				<?php
					...
					echo "<label><i class='fa fa-address-card-o' aria-hidden='true'></i>Digite o Usuário Atual: <input type='text' style='width:400px ' name='usuario' placeholder='Digite o usuário atual válido . . .' required='' ></label> ";
