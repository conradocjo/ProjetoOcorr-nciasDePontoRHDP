...
<body>
	...
	<?php require_once"../../../menu.php";?>
		...
		<?php
			...
			$insert_dados = "UPDATE usuario_gestor SET nivel =  '$grupo', usuario_rastro_atualizacao = '$usuario_sessao' WHERE usuario = '$user_post' ";
			...
			if ($validacao1 = mysqli_num_rows($testa_dados)){
				insert($insert_dados);
				echo "<div class='cadastro_existente'><h1>Grupo do usuário $user_post alterado com sucesso.</h1></div>";
			}else{
				if($senha==""){
