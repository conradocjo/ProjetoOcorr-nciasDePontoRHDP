...
<body>
	...
	<?php require_once"../../../menu.php";?>
		...
		<?php
			...
			$insert_dados = "UPDATE empregado SET fk_unidade =  '$unidades', usuario_rastro_atualizacao = '$usuario_sessao' WHERE matricula = '$matricula' ";
			...
			if ($validacao1 = mysqli_num_rows($testa_dados)){
				insert($insert_dados);
				echo "<div class='cadastro_existente'><h1>Unidade do usuário de matrícula $matricula alterado com sucesso.</h1></div>";
			}else{
				if($senha==""){
