...
<body>
	...
	<div class="">
		<form class="form_cadastro_unidade" action="excluindo_unidade.php" method="post" accept-charset="utf-8">
		<fieldset>
			<legend>Excluir Unidade</legend>
				<?php
						...
						echo"<i class='fa fa-building-o' aria-hidden='true'></i> Unidade que deseja excluir:  <select name='unidade' >";
