									...
									<tbody>
										";
											...
											while ($resultado3 = mysqli_fetch_array($select_ocorrencia)) {
												...
												}else if ($resultado3[12] == '0') {
													echo"<td>Ocorrência passada ao gestor.</td>";
												}
