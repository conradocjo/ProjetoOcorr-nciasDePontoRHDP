									...
									<tbody>
										";
											...
											while ($resultado3 = mysqli_fetch_array($select_ocorrencia)) {
												...
												if ($resultado3[12] == '2') {
													echo"<td>Ocorrência não aprovada</td>";
												}
